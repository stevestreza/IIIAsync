#
#  Be sure to run `pod spec lint IIIAsync.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/stevestreza/IIIAsync.git", :tag => "v#{s.version}" }
  ...
  s.source_files  = "IIIAsync", "IIIAsync/**/*.{h,m}"
